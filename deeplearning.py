...
#print('X_promoter_train_type',type(X_promoter_train))
#print('X_promoter_train',X_promoter_train)
#print('X_promoter_train.values[:,1][0].shape',X_promoter_train.values[:,1][0].shape[0])
#print('X_promoter_train.values[:,1]',X_promoter_train.values[:,1])
#print('X_promoter_train.values[:,1][0]',X_promoter_train.values[:,1][0])

# Training model
from hyperopt import STATUS_OK
# train model 10 times
for i in range(10):     # 10 times and select the best model 
